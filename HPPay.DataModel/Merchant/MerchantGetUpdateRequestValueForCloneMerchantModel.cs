...
{
    public class MerchantGetUpdateRequestValueForCloneMerchantModelInput:BaseClass
    {
    ...
    public class MerchantGetUpdateRequestValueForCloneMerchantModelOutput : BaseClassOutput
    {
