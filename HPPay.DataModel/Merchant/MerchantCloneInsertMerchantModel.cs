...
{
    public class MerchantCloneInsertMerchantModelInput:BaseClass
    {

        [Required]
        [JsonPropertyName("OldMerchantId")]
        [DataMember]
        ...
        [Required]
        [JsonPropertyName("NoofLiveTerminals")]
        [DataMember]
    ...
    public class MerchantCloneInsertMerchantModelOutput : BaseClassOutput
    {
