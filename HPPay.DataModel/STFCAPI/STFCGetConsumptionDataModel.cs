...
{
    public class STFCGetConsumptionDataModelInput:STFCAPIBaseClassInput
    {
        [Required]
    ...
    public class STFCAPIGetConsumptionDataModelOutput
    {
    ...
    //public class GetconsumptionRes : STFCAPIBaseClassOutput
    //{
    //    [JsonProperty("headerDetails")]
    //    [DataMember]
    ...
    //public class GetRespCodeMessageDetails : STFCAPIBaseClassOutput
    //{
...
//public class STFCGetConsumptionDataModelOutput : STFCAPIBaseClassOutput
//{
