...
{
        public class CustomerRelationshipBusinessSolicitationCallReportModelInput : BaseClass
        {
        ...
        [Required]
            ...
            [JsonPropertyName("TypeAreaofOperation")]
            [DataMember]
            public List<TypeAreaofOperation> TypeAreaofOperation { get; set; }


            [JsonPropertyName("TypeMappingBusinessSolicitation")]
            [DataMember]
            public List<TypeMappingBusinessSolicitation> TypeMappingBusinessSolicitation { get; set; }


            [JsonPropertyName("TypeMeetingRemarkBusinessSolicitation")]
            [DataMember]
            public List<TypeMeetingRemarkBusinessSolicitation> TypeMeetingRemarkBusinessSolicitation { get; set; }
        }

        public class TypeAreaofOperation
        {
            [Required]
        ...
        public class TypeMappingBusinessSolicitation
        {
        ...
        public class TypeMeetingRemarkBusinessSolicitation
        {
            [Required]
        ...
        public class CustomerRelationshipBusinessSolicitationCallReportModelOutput : BaseClassOutput
        {
