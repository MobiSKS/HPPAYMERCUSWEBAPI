...
{
    public class AggregatorCustomerGetByCustomerIdModelInput : BaseClass
    {
    ...
    public class AggregatorCustomerGetCustomerNameModelOutput
    {
    ...
    public class AggregatorCustomerGetCustomerDetailsForSearchModelOutput
    {
    ...
    public class AggregatorCustomerDetailsModelInput : BaseClass
    {
        [JsonPropertyName("CustomerID")]
        [DataMember]
        public string CustomerID { get; set; }
    ...
    public class AggregatorCustomerDetailsbyFormNumberModelInput : BaseClass
    {
        [JsonPropertyName("FormNumber")]
        [DataMember]
        public Int64 FormNumber { get; set; }
    ...
    public class AggregatorCustomerDetailsModelOutput
    {
        [JsonProperty("GetAggregatorCustomerDetails")]
        public List<AggregatorGetCustomerDetailsModelOutput> GetAggregatorCustomerDetails { get; set; }

        [JsonProperty("AggregatorCustomerKYCDetails")]
        public List<AggregatorCustomerKYCDetailsModelOutput> AggregatorCustomerKYCDetails { get; set; }
    }

    public class AggregatorGetCustomerDetailsModelOutput
    {
        [JsonProperty("CustomerID")]
        [DataMember]
        public string CustomerID { get; set; }
    ...
    public class AggregatorCustomerKYCDetailsModelOutput
    {
    ...
    public class BindPendingAggregatorCustomerModelInput : BaseClass
    {
    ...
    public class BindPendingAggregatorCustomerModelOutput
    {
