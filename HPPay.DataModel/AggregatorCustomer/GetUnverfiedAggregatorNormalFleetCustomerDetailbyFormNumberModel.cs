...
namespace HPPay.DataModel.AggregatorCustomer
{
    ...
    public class AggregatorNormalFleetCustomerDetailsbyFormNumberModelInput : BaseClass
    {
        [JsonPropertyName("FormNumber")]
        [DataMember]
        public Int64 FormNumber { get; set; }
    }
    public class AggregatorNormalFleetCustomerDetailsModelOutput
    {
        [JsonProperty("GetAggregatorCustomerDetails")]
        public List<AggregatorNormalFleetGetCustomerDetailsModelOutput> GetAggregatorCustomerDetails { get; set; }

        [JsonProperty("AggregatorCustomerKYCDetails")]
        public List<AggregatorNormalFleetCustomerKYCDetailsModelOutput> AggregatorCustomerKYCDetails { get; set; }
    }
    public class AggregatorNormalFleetGetCustomerDetailsModelOutput
    {
    ...
    public class AggregatorNormalFleetCustomerKYCDetailsModelOutput
    {
