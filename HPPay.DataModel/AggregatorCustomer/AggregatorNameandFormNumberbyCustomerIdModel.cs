...
{
    public class GetAggregatorNameandFormNumberbyCustomerIdModelInput : BaseClass
    {
        [Required]
    ...
    public class GetAggregatorNameandFormNumberbyCustomerIdModelOutput
    {
    ...
    public class GetAggregatorNameandFormNumberModelOutput
    {
