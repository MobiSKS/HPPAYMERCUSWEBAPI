...
{
    internal class GetAggregatorNormalFleetCustomerNameandFormNumberbyReferenceNoforCustomerModel
    {
    }
    public class AggregatorNormalFleetCustomerGetCustomerReferenceNoforCustomerModelInput : BaseClass
    {
    ...
    public class AggregatorNormalFleetCustomerGetCustomerReferenceNoforCustomerModelOutput : BaseClassOutput
    {
        //[JsonProperty("Title")]
        //[DataMember]
