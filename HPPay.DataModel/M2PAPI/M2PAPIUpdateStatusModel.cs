...
{
    public class M2PAPIUpdateStatusModelInput:M2PAPIBaseClassInput
    {
        ...
        [DataMember]
        public int ApplicabilityCustomerCard { get; set; }
    ...
    public class M2PAPIUpdateStatusModelMainOutput : STFCAPIBaseClassOutput
    {
    ...
    public class M2PAPIUpdateStatusModelOutput
    {
