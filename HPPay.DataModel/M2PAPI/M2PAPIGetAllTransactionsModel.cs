...
{
    public class M2PAPIGetAllTransactionsModelInput:M2PAPIBaseClassInput
    {
    ...
    public class M2PAPIGetAllTransactionsModelOutput
    {
    ...
    public class M2PAPIGetAllTransactionsModelFInalOutput
    {
    ...
    public class TransactionDetails : M2PAPIBaseClassOutput
    {
        [JsonProperty("customerId")]
        [DataMember]
        public string customerId { get; set; }
