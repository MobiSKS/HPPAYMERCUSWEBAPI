...
{
    public class DICVDealerEnrollmentModelInput : BaseClass
    {
        [Required]
    ...
    public class DICVDealerEnrollmentModelOutput : BaseClassOutput
    {
        ...
        [DataMember]
        public Int64 DealerStatus { get; set; }
    ...
    public class GetDICVOfficerTypeModelInput : BaseClass
    {
    ...
    public class GetDICVOfficerTypeModelOutput : BaseClassOutput
    {
