...
{
    public class DICVCustomerDetailsModelInput : BaseClass
    {
    ...
    public class DICVCustomerDetailsModelOutput:BaseClassOutput
    {
        [JsonProperty("GetCustomerDetails")]
        public List<GetDICVCustomerDetailsModelOutput> GetCustomerDetails { get; set; }

        [JsonProperty("CustomerKYCDetails")]
        public List<DICVCustomerKYCDetailsModelOutput> CustomerKYCDetails { get; set; }

    }
    public class DICVCustomerKYCDetailsModelOutput:BaseClassOutput
    {
    ...
    public class GetDICVCustomerDetailsModelOutput:BaseClassOutput
    {
