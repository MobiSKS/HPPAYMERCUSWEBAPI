...
{
    public class GetDICVCardLimtModelInput : BaseClass
    {
        [Required]
    ...
    public class GetDICVCardLimtModelOutput
    {
        [JsonProperty("GetCardsDetailsModelOutput")]
        public List<GetDICVCardsDetailsModelOutput> GetCardsDetails { get; set; }

        [JsonProperty("GetCardLimtModel")]
        public List<DICVCardLimtModelOutput> GetCardLimt { get; set; }

        [JsonProperty("CardServices")]
        public List<DICVCardServicesModelOutput> CardServices { get; set; }
    }

    public class DICVCardLimtModelOutput
    {
    ...
    public class DICVCardServicesModelOutput
    {
    ...
    public class GetDICVCardsDetailsModelOutput
    {
