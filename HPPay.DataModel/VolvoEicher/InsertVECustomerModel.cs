...
{
    public class InsertVECustomerModelInput:BaseClass
    {
        [Required]
        ...
        [JsonPropertyName("ObjVECardEntryDetail")]
        [DataMember]
        public List<VECardEntryDetail> ObjVECardEntryDetail { get; set; }
    }
    public class VECardEntryDetail
    {
    ...
    public class InsertVECustomerModelOutput : BaseClassOutput
    {
