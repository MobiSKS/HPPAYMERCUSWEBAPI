...
namespace HPPay.DataModel.VolvoEicher
{
    ...
    public class VolvoCustomerDetailsModelInput : BaseClass
    {
    ...
    public class VolvoCustomerDetailsModelOutput
    {
        [JsonProperty("GetCustomerDetails")]
        public List<GetvolvoCustomerDetailsModelOutput> GetCustomerDetails { get; set; }

        [JsonProperty("CustomerKYCDetails")]
        public List<VolvoCustomerKYCDetailsModelOutput> CustomerKYCDetails { get; set; }
    }
    public class VolvoCustomerKYCDetailsModelOutput
    {
    ...
    public class GetvolvoCustomerDetailsModelOutput
    {
