...
{
    public class GetVEDealerNameModelInput:BaseClass
    {
    ...
    public class GetVEDealerNameModelOutput
    {
    ...
    public class CheckVEDealerCodeModelInput : BaseClass
    {
        [Required]
        [JsonPropertyName("DealerCode")]
        [DataMember]
    ...
    public class CheckVEDealerCodeModelOutput : BaseClassOutput
    {
