...
{
    public class VECustomerDetailUpdateModelInput : BaseClass
    {
        [Required]
    ...
    public class VECustomerDetailUpdateModelOutput : BaseClassOutput
    {

    }

    public class ApprovalVECustomerUpdateRequestModelInput : BaseClass
    {
        ...
        [DataMember]
        public List<VECustomerApproval> CustomerApprovalList { get; set; }
    }

    public class VECustomerApproval
    {
    ...
    public class ApprovalVECustomerUpdateRequestModelOutput : BaseClassOutput
    {
