...
{
    public class JCBCustomerDetailsModelInput : BaseClass
    {
    ...
    public class JCBCustomerDetailsModelOutput
    {
        [JsonProperty("GetCustomerDetails")]
        public List<GetJCBCustomerDetailsModelOutput> GetCustomerDetails { get; set; }

        [JsonProperty("CustomerKYCDetails")]
        public List<JCBCustomerKYCDetailsModelOutput> CustomerKYCDetails { get; set; }
    }
    public class JCBCustomerKYCDetailsModelOutput
    {
    ...
    public class GetJCBCustomerDetailsModelOutput
    {
