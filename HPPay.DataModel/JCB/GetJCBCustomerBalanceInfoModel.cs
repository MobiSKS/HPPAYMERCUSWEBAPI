...
{
    internal class GetJCBCustomerBalanceInfoModel
    {
    }
    public class GetJCBCustomerBalanceInfoModelInput : BaseClass
    {
    ...
    public class GetJCBCustomerBalanceInfoModelOutput
    {
