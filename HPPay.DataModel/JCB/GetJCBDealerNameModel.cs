...
{
    public class GetJCBDealerNameModelInput : BaseClass
    {
        //[Required]
    ...
    public class GetJCBDealerNameModelOutput : BaseClassOutput
    {
    ...
    public class CheckJCBDealerCodeModelInput : BaseClass
    {
        [Required]
        [JsonPropertyName("DealerCode")]
        [DataMember]
    ...
    public class CheckJCBDealerCodeModelOutput : BaseClassOutput
    {

    }


    public class GetJCBOfficerTypeModelInput : BaseClass
    {
    ...
    public class GetJCBOfficerTypeModelOutput : BaseClassOutput
    {
    ...
    public class EnableDisableJCBDealerModelInput : BaseClass
    {
        [Required]
        [JsonPropertyName("DealerCode")]
        [DataMember]
    ...
    public class EnableDisableJCBDealerModelOutput : BaseClassOutput
    {
    }
}
