...
{
    public class JCBCustomerDetailUpdateModelInput : BaseClass
    {
        [Required]
    ...
    public class JCBCustomerDetailUpdateModelOutput : BaseClassOutput
    {

    }
    public class ApprovalJCBCustomerUpdateRequestModelInput : BaseClass
    {
        ...
        [DataMember]
        public List<JCBCustomerApproval> CustomerApprovalList { get; set; }
    }

    public class JCBCustomerApproval
    {
    ...
    public class ApprovalJCBCustomerUpdateRequestModelOutput : BaseClassOutput
    {
