...
{
    public class CustomerAPIChildtoParentBalanceTransferRequestModelInput:CustomerAPIBaseClassInput
    {
        [Required]
    ...
    public class CustomerAPIChildtoParentBalanceTransferRequestModelOutput : CustomerAPIBaseClassOutput
    {
