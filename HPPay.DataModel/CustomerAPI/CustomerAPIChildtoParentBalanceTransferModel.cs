...
{
    public class CustomerAPIChildtoParentBalanceTransferModelInput:CustomerAPIBaseClassInput
    {
        [Required]
    ...
    public class CustomerAPIChildtoParentBalanceTransferModelOutput : CustomerAPIBaseClassOutput
    {
