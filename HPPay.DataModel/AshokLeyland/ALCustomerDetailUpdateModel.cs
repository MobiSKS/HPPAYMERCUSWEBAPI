...
{
    public class ALCustomerDetailUpdateModelInput : BaseClass
    {
        [Required]
    ...
    public class ALCustomerDetailUpdateModelOutput : BaseClassOutput
    {

    }

    public class ApprovalALCustomerUpdateRequestModelInput : BaseClass
    {
        ...
        [DataMember]
        public List<CustomerApproval> CustomerApprovalList { get; set; }
    }
    ...
    public class ApprovalALCustomerUpdateRequestModelOutput : BaseClassOutput
    {
