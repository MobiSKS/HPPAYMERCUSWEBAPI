...
namespace HPPay.DataModel.AshokLeyland
{
    ...
    public class GetALCardLimtModelInput : BaseClass
    {
        [Required]
    ...
    public class GetALCardLimtModelOutput
    {
        [JsonProperty("GetCardsDetailsModelOutput")]
        public List<GetALCardsDetailsModelOutput> GetCardsDetails { get; set; }

        [JsonProperty("GetCardLimtModel")]
        public List<ALCardLimtModelOutput> GetCardLimt { get; set; }

        [JsonProperty("CardServices")]
        public List<ALCardServicesModelOutput> CardServices { get; set; }
    }

    public class ALCardLimtModelOutput
    {
    ...
    public class ALCardServicesModelOutput
    {
    ...
    public class GetALCardsDetailsModelOutput
    {
