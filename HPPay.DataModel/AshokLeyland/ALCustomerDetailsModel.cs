...
{
    public class ALCustomerDetailsModelInput : BaseClass
    {
    ...
    public class ALCustomerDetailsModelOutput
    {
        [JsonProperty("GetCustomerDetails")]
        public List<GetALCustomerDetailsModelOutput> GetCustomerDetails { get; set; }

        [JsonProperty("CustomerKYCDetails")]
        public List<ALCustomerKYCDetailsModelOutput> CustomerKYCDetails { get; set; }

    }
    public class ALCustomerKYCDetailsModelOutput
    {
    ...
    public class GetALCustomerDetailsModelOutput
    {
