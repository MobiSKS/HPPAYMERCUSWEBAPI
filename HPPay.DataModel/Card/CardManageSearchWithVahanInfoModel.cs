...
{
    public class CardManageSearchWithVahanInfoModelnput: BaseClass
    {
        //[Required]
    ...
    public class CardManageSearchWithVahanInfoModelOutput
    {
        ...
        [JsonProperty("VehicleClassDescription")]
        [DataMember]
