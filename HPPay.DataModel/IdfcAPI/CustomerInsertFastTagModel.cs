...
namespace HPPay.DataModel.IdfcAPI
{
        ...
        public class CustomerInsertFastTagModelInput : BaseClass
        {
        ...
        [JsonPropertyName("IsHPPAYSettlement")]
        [DataMember]
        public Int32 IsHPPAYSettlement { get; set; }
        ...
        public class CustomerInsertFastTagModelOutput : BaseClassOutput
        {
