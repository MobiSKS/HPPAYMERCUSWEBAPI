...
{
    public class GetParentCustomerToUpdateModelInput : BaseClass
    {
    ...
    public class GetParentCustomerToUpdateModelOutput
    {

        [JsonProperty("GetParentCustomerDetails")]
        public List<GetParentCustomerDetailsModelOutput> GetParentCustomerDetails { get; set; }

    }
    public class GetParentCustomerDetailsModelOutput
    {
